...
function takePicture() {
  ...
  NodeWebcam.capture('public/'+imageName, opts, function( err, data ) {  
    Jimp.read("public/" + imageName + '.jpg').then(function (image) {
        ...
        palette.push(JSON.stringify(image.intToRGBA( image.getPixelColor(150,150) )));
        palette.push(JSON.stringify(image.intToRGBA( image.getPixelColor(50,50)   )));
        palette.push(JSON.stringify(image.intToRGBA( image.getPixelColor(250,50)  )));
        palette.push(JSON.stringify(image.intToRGBA( image.getPixelColor(50,250)  )));
        palette.push(JSON.stringify(image.intToRGBA( image.getPixelColor(250,250) )));
